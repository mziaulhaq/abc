        ...
        <td>
            <table style="width: 97%">
                ...
                <asp:ListView ID="lstDynamicCategories" runat="server">
                    <ItemTemplate>
                    <tr>
                    <td><span class="well"><asp:Literal runat="server" ID="ltDynamicCat" Text='<%# Bind("DyCatName") %>'></asp:Literal></span></td>
                    <td><span class="well"><asp:Literal runat="server" ID="ltVal" Text='<%#  Bind("DyCatValue") %>'></asp:Literal></span></td>
                    </tr>
                    </ItemTemplate>
                </asp:ListView>
