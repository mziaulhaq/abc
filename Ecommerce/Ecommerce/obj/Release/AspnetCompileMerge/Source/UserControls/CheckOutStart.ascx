...
<div style="border-style: solid; border-color: inherit; border-width: 1px; float: left; width: 35%">
    <div>
    ...
    <asp:Repeater runat="server" ID="rptPaymentMethods">
        <ItemTemplate>
            <div style="border-bottom: 1px solid; border-bottom-color: inherit; margin-top: 5px;">
                <asp:RadioButton runat="server" ID="rdbPaymentMethod" ClientIDMode="Static" Text='<%#Eval("PaymentMethodName") %>' GroupName='zia' onclick="SelectRadioButton('zia$',this)" />
                <br />
