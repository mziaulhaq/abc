<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Default/OtherPages.Master" AutoEventWireup="true" CodeBehind="SignIn.aspx.cs" Inherits="Ecommerce.SignIn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contents" runat="server">
    ...
    <table class="auto-style1">
        <tr>
            <td colspan="4"><label class="LargeFont text-center lead">Sign Up Here</label></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtEmail" ErrorMessage="Email" ForeColor="Red" ValidationGroup="Signup">*</asp:RequiredFieldValidator>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtPwd" runat="server" TextMode="Password" ValidationGroup="Signup"></asp:TextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtPwd" ErrorMessage="Password" ForeColor="Red" ValidationGroup="Signup">*</asp:RequiredFieldValidator>
            </td>
            <td></td>
        </tr>
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtConfirmPwd" runat="server" TextMode="Password" ValidationGroup="Signup"></asp:TextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtConfirmPwd" ErrorMessage="Confirm Password" ForeColor="Red" ValidationGroup="Signup">*</asp:RequiredFieldValidator>
                <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtPwd" ControlToValidate="txtConfirmPwd" ErrorMessage="Confirm Password Must Match" ForeColor="Red" ValidationGroup="Signup">*</asp:CompareValidator>
            </td>
            <td></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtMobileNumber" runat="server" CssClass="positive-integer" MaxLength="15" ValidationGroup="Signup"></asp:TextBox>
            </td>
            <td>
        ...
        <tr>
            <td></td>
            <td>  <asp:Button ID="btnSignIn" runat="server" Text="Sign Up" CssClass="inline btn-success btn-info btn ShopNow" OnClick="BtnSignUpClicked" ValidationGroup="Signup" />
