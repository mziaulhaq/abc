...
<table class="ui-accordion">
    ...
    <tr>
        <td class="auto-style1">
            <label>Materials</label></td>
    </tr>
    <tr>
        <td>
            <asp:GridView ID="gdvMaterials" runat="server" Width="100%" AutoGenerateColumns="False" CssClass="mytable">
                <Columns>
                    <asp:BoundField HeaderText="Materials" DataField="meterialName" />
                </Columns>
            </asp:GridView>
        </td>
    </tr>
