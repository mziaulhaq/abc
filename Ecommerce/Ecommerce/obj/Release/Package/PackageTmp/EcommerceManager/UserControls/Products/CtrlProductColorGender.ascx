...
<table class="ui-accordion">
    ...
    <tr>
        ...
        <td>
            <asp:DropDownList ID="ddlMetarial" runat="server" ValidationGroup="ProductGender" DataTextField="meterialName" DataValueField="meterialId">
            </asp:DropDownList>
        </td>
        <td>
            <%--<asp:CompareValidator ID="CompareValidator3" runat="server" ControlToValidate="ddlGender" ErrorMessage="Please Select Material" ForeColor="Red" ValidationGroup="ProductGender" ValueToCompare="Select" Operator="NotEqual">*</asp:CompareValidator>--%>
        </td>
    </tr>
    <tr>
        <td>&nbsp;</td>
    ...
    <tr>
        <td>&nbsp;</td>
        <td>
            <asp:Button ID="btnAddMetarial" runat="server" Text="Add Metarial" OnClick="BtnMetarialClicked" />
            <%--<asp:ValidationSummary ID="ValidationSummary3" runat="server" HeaderText="Following are required fields" ShowMessageBox="True" ShowSummary="False" ValidationGroup="ProductGender" />--%>
        </td>
        <td>&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="3">
            <asp:GridView ID="GdvMetarial" runat="server" Width="100%" AutoGenerateColumns="False" CssClass="mytable" DataKeyNames="metarialId" OnRowDeleting="GdvMetarialDeleted">
                <Columns>
                    <asp:BoundField HeaderText="Product Name" DataField="ProductName">

                        <HeaderStyle CssClass="GrdFirstHeader" />
                    </asp:BoundField>
                    <asp:BoundField HeaderText="Metarial" DataField="meterialName" />
                    <asp:TemplateField ShowHeader="False">
                        <ItemTemplate>
                            <asp:ImageButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="Delete" Text="Delete" OnClientClick="javascript:return confirm('Are you sure you want to delete this record');" ImageUrl="../../../Images/Gridicons/delete.png" Width="24px" Height="24px"></asp:ImageButton>
                        </ItemTemplate>
