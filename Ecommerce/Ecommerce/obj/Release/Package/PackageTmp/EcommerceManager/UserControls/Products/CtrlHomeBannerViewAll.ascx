...
<div>
    <table style="width: 35%">
        <tr>
            <td>
                <a href="AddHomeBanner.aspx">Create New</a>
            </td>
    ...
    <table class="ui-accordion">
        ...
        <tr>
            <td style="overflow-x: scroll" align="center">
                <asp:GridView ID="gdvHomeBanners" runat="server" AutoGenerateColumns="False" DataKeyNames="HPBId" CssClass="mytable" AllowPaging="True" PageSize="20" OnPageIndexChanging="GdvHomeBannersPageIndexChanging">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Status">
                            <ItemTemplate>
                                <asp:Label ID="Label2" runat="server" Text='<%#EcommerceUtilities.EnablingAndDisabling.ReturnStringValueBasedOnInt(Convert.ToInt32(Eval("IsActive"))) %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <EditItemTemplate>
                        ...
                        <asp:TemplateField ShowHeader="False">
                            <ItemTemplate>
                                <asp:HyperLink runat="server" ID="hlEditProduct" NavigateUrl='<%# HomeEditBannerLink(Eval("HPBId").ToString(),"Edit") %>'>
