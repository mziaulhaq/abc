...
<asp:Content ID="Content2" ContentPlaceHolderID="Contents" runat="server">
    <div id="MainDiv" runat="Server">
        <table class="auto-style1">
            <tr>
                <td colspan="4">
                    <label class="LargeFont text-center lead">Sign Up Here</label></td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td></td>
                <td>
                    <asp:Button ID="btnSignIn" runat="server" Text="Sign Up" CssClass="inline btn-success btn-info btn ShopNow" OnClick="BtnSignUpClicked" ValidationGroup="Signup" />
