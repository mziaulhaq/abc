...
<%--    function uploadError(sender, args) {
    ...
    function uploadStart(sender, args) {
        ...
        var txtName = document.getElementById('<%= txtBannerTitle.ClientID%>');
        if (txtName.value != "") {
...
<table class="ui-accordion">
    <tr>
        <td class="auto-style1">
            <asp:Label ID="lblBannerID" runat="server"></asp:Label>
        </td>
    ...
    <tr>
        <td class="auto-style1">
            <label id="Label1">Banner Name</label>
        </td>
        <td class="auto-style1">
            <asp:TextBox ID="txtBannerTitle" runat="server" Width="335px"></asp:TextBox>
        </td>
        <td class="auto-style1">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtBannerTitle" ErrorMessage="Name" Font-Size="Medium" ForeColor="Red" ValidationGroup="HomeBanner">*</asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr id="bannerOrder" runat="server">
        <td class="auto-style1">
            Order</td>
        <td class="auto-style1">
            <asp:TextBox ID="txtBannerOrder" runat="server" Width="335px"></asp:TextBox>
        </td>
        <td class="auto-style1">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtBannerOrder" ErrorMessage="Name" Font-Size="Medium" ForeColor="Red" ValidationGroup="HomeBanner">*</asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <td class="auto-style1">
    ...
    <tr>
        <td class="auto-style1">Banner Link</td>
        <td id="uploaderInside">
            <asp:TextBox ID="txtBannerLink" runat="server" Width="335px"></asp:TextBox>

        </td>
        <td valign="middle">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtBannerLink" ErrorMessage="Name" Font-Size="Medium" ForeColor="Red" ValidationGroup="HomeBanner">*</asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <td class="auto-style1">
            <label id="Label11">Banner Image</label>
        </td>
        <td id="uploaderInside" class="auto-style1">
            ...
            <ajaxToolkit:AsyncFileUpload runat="server" ID="ProductImage" UploaderStyle="Traditional"
                OnUploadedComplete="AsyncFileUploadUploadedComplete" />
        </td>
        <td valign="middle" class="auto-style1">
            ...
            <asp:CustomValidator ID="cvImage" runat="server" ErrorMessage="Please Upload Image" ForeColor="Red" ValidationGroup="HomeBanner" OnServerValidate="ImageUploadServerValidate">*</asp:CustomValidator>
        </td>
    </tr>
    <tr>
        <td>
