<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlConfirmOrders.ascx.cs" Inherits="Ecommerce.EcommerceManager.UserControls.CtrlConfirmOrders" %>
<style type="text/css">
        ...
        <td>
            <table class="auto-style1" runat="server" id="tblDetail">
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>
                        <asp:Button ID="BtnDeliverOrder" runat="server" Height="26px" OnClick="BtnDeliverOrderClicked" Text="Deliver Order" OnClientClick="javascript:return confirm('Are you sure you want to confirm this order');" />
&nbsp;&nbsp;
