...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Wizard ID="ProductWizard" runat="server" OnPreRender="WizardPreRender"  DisplaySideBar="False" OnPreviousButtonClick="ProductWizard_PreviousButtonClick" OnFinishButtonClick="ProductWizardFinishButtonClicked" ActiveStepIndex="4">
    <HeaderTemplate>
        <ul id="wizHeader">
