<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Default/OtherPages.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Ecommerce.Login" %>
    ...
    <div>
        ...
        <div class="row" style="margin-left: 30%">
            <div class="span4" style="color: black;">
                ...
                <div>
                    <div>
                        <asp:TextBox runat="server" Style="width: 280px;" ID="txtEmail" type="text" class="form-control" placeholder="Enter Email"></asp:TextBox>
                    </div>
                </div>
                ...
                <div>
                    <div>
                        <asp:TextBox runat="server" Style="width: 280px;" ID="txtPwd" type="password" class="form-control" placeholder="Enter Password"></asp:TextBox>
                    </div>
                </div>
            </div>
        ...
        <div class="row" style="margin-left: 30%">
            <div class="span4">
                ...
                <div style="width: 292px">
                    <asp:Button Style="float: right" ID="btnLogin" runat="server" Width="100px" Height="35px" class="InlineBlock btn-success btn-info btn loginButton" Text="Sign In" ValidationGroup="vgLogin" OnClick="btnLogin_Click" />
